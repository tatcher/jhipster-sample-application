...
export class LocationDeleteDialog extends React.Component<ILocationDeleteDialogProps> {
  ...
  confirmDelete = event => {
    this.props.deleteEntity(this.props.locationEntity.id);
  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="jhipsterSampleApplicationApp.location.delete.question">Are you sure you want to delete this Location?</ModalBody>
        <ModalFooter>
