...
public class EmployeeResource {
    ...
    public ResponseEntity<List<Employee>> getAllEmployees(Pageable pageable, @RequestParam MultiValueMap<String, String> queryParams, UriComponentsBuilder uriBuilder) {
